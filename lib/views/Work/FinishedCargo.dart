...
class FinishedCargo extends StatefulWidget {
  final AppLocalizations? localizations;
  final int? id;
  @override
  const FinishedCargo({Key? key, this.localizations, this.id})
      : super(key: key);

  @override
  _FinishedCargoState createState() => _FinishedCargoState();
}

class _FinishedCargoState extends State<FinishedCargo> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<Cargo> activeCargos = cargoJson
            ...
            .where((cargo) => cargo.status == 'FINISHED')
            .toList();
        return activeCargos;
      } else {
