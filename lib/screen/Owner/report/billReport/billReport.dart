...
class billReportcomponent extends StatefulWidget {
  ...
  @override
  State<billReportcomponent> createState() => _alertComponentforownerState();
}

class _alertComponentforownerState extends State<billReportcomponent> {
  bool isVisible = true;
