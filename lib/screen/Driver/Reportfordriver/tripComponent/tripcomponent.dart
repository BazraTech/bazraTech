...
class tripComponentfordriver extends StatefulWidget {
  @override
  State<tripComponentfordriver> createState() => _tripComponentfordriverState();
}

class _tripComponentfordriverState extends State<tripComponentfordriver> {
  bool isVisible = true;
