...
export default function () {
    ...
    // const url2 = `http://198.199.67.201:9090/Api/Admin/Trip/All/${user.id}`;
        ...
        <div className="">
            ...
            <section className={styles.main_content}>
                ...
                <div className={styles.tripHeader}>
                    ...
                    <Link style={{ textDecoration: 'none' }} to="/trip_history"><p><h1 className={styles.avaliableVehicles}>Trip History</h1></p></Link>
                </div>
                ...
                <form className='form' onSubmit={handleSubmit(onSubmit)}>
                    <div className={styles.allDiv}>
                        <div>
                            ...
                            <h1 className={styles.greentrip}>Trip History</h1>
                            {
                                    ...
                                    <>
                                        <>
                                            <div className={styles.companyList}>
                                                ...
                                                <label>Owuner : <b className='green'>{user.name}</b></label>
