...
// console.log(updateCargoInfo)
  ...
  const update = async () => {
    ...
    formData.append("name", updateCargoInfo.companyName); //Coudn't change the name  i don't know
      ...
      <div className="users_edit_container">
        ...
        <section className={styles.main_content}>
          <div className={styles.company_individual_header}>
            <p>
              <h1 className={styles.companyHeader}>Company Detail</h1>
            </p>
            <p>
              <h4 className={styles.vehicleDetail}>
                Name : {cargoOwnerInfo.ownerName}
                <br />
                User ID : {cargoOwnerInfo.id}
              </h4>
            </p>
          </div>
            ...
            <div className={styles.allDiv}>
              <>
                      ...
                      {!selecttag ? (
                        ...
                        >
                          {BusinesSector.map((item) => (
                            <option
                              key={item.businessSector}
                              value={item.businessSector}
                            >
                              {item.businessSector}
                            </option>
                          ))}
                    ...
                    <div>
                      ...
                      <div style={{ display: "flex" }}>
                        <input
                          ...
                          id="enable"
                          value={
                            cargoEnabled === "true" ? "Enabled" : "Disabled"
                          }
                          type="text"
                        ></input>
                        {cargoEnabled === "true" ? (
                          <BsToggleOn
                            onClick={() => enableDisable(cargoOwnerInfo.id)}
                ...
                <div className={styles.company_button}>
                  ...
                  <br />
                  <button className={styles.ad} disabled={diabled}>
                    Update
                  </button>
                </div>
              </>
