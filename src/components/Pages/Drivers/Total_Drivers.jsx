                                        ...
                                        <div className={styles.formDiv1}>
                                            ...
                                            <div className={styles.input}>
                                                ...
                                                <input name='licensePic' type="file"
                                                    // value={licensePic}
                                                    {...register("licensePic", { required: '*Driver Licence Picture required' })}
                                            ...
                                            <div className={styles.input}>
                                                ...
                                                <input name='licenseGrade' type="text"
                                                    value={licenseGrade}
                                                    {...register("licenseGrade", { required: '*Iicense Grade required' })}
                                            ...
                                            <div className={styles.input}>
                                                ...
                                                <input name='Issue Date' type="date"
                                                    ...
                                                    {...register("licenseIssueDate", { required: '*Issue Date required' })}
                                            ...
                                            <div className={styles.input}>
                                                ...
                                                <input name='Expire Date' type="date"
                                                    ...
                                                    {...register("licenseExpireDate", { required: '*Expire Date is required' })}
